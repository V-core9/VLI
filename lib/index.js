...
const vLog = {
  ...
  printMessage(logItem) {
    ...
    switch (logItem.type) {
      case "log":
        styledMessage = boxen(chalk.rgb(50, 150, 50)(styledMessage), { title: chalk.bgRgb(50, 150, 50)(` 🥏 Msg_UID : ${logItem.uid} `), padding: { top: 0, left: 2, right: 1, bottom: 0 } });
        break;
      case "info":
        styledMessage = boxen(chalk.rgb(50, 150, 210)(styledMessage), { title: chalk.bgRgb(10, 100, 200)(` ⏭ Info_UID : ${logItem.uid} `), padding: { top: 0, left: 2, right: 1, bottom: 0 } })
        break;
      case "warn":
